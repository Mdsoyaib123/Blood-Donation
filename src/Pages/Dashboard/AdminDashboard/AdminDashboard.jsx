    ...
    <div>
      ...
      <div>
        <div className="flex  gap-5 mb-6">
          <div className="flex justify-between px-8 py-8 rounded-md items-center w-1/2 bg-[#9ADE7B]">
          ...
          <div className="flex justify-between px-8 py-8 rounded-md items-center w-1/2 bg-[#F5CCA0]">
        ...
        <div className="flex gap-5 ">
          <div className="flex justify-between px-8 py-8 rounded-md items-center w-1/2 bg-[#6DB9EF]">
