    ...
    <div className="h-screen relative mb-28">
      ...
      <div className="hidden lg:flex justify-center">
        <div className="text-center text-white font-bold absolute top-60">
          ...
          <Link to={"/register"}>
            <button className=" bg-red-600 px-5 py-3 rounded-md border hover:bg-[#e61710]  mr-12 text-xl">
              Join as a donor
            </button>
          </Link>
          <Link to={'/searchDonors'}>
            <button className=" bg-red-600 px-5 py-3 rounded-md border hover:bg-[#e61710] text-xl text-white ">
              Search Donors
            </button>
          </Link>
        </div>
